...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiBriefcase, FiTool } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['department-head', 'inventory-manager', 'equipment-supervisor'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Equipment', path: '/equipment', entity: 'equipment', service: AccessServiceEnum.PROJECT, icon: FiTool },
